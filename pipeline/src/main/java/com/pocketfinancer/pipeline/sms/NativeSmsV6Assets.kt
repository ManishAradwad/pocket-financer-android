 ...
 */
object NativeSmsV6Assets {
    const val RELEASE_ID = "native-integration-v6"
    const val MANIFEST_SHA256 =
        "b7ce1047c998dceae8935486a9982c0bda663ff43cebaaa284f6d542a81ab3e8"
    const val ASSET_ROOT = "sms_processing/native-integration-v6"
    const val MANIFEST_PATH =
        "$ASSET_ROOT/configs/sms_processing/contracts/releases/native-integration-v6.json"
    const val PROCESSING_CONFIG_SHA256 =
        "59bd6489ca1b69e0951fc9281fe1bb930c4c5cfd201330e0ffdaa3e5d67446d3"
    ...
    const val MANIFEST_SCHEMA_SHA256 =
        "6fe68fa631f8fc741546332a1c75478f01ea3ed71d70880c72a30a32a3ecff6a"
    ...
    fun verify(assetManager: AssetManager): NativeSmsV3AssetBinding = try {
        ...
        check(routing.getString("processing_config_contract") == "pocketfinancer.processing-config/6")
        ...
        check(bindings["pocketfinancer.processing-config/6"]?.sha256 == PROCESSING_CONFIG_SHA256)
        ...
        check(bindings["pocketfinancer.contract-release-manifest-schema/6"]?.sha256 == MANIFEST_SCHEMA_SHA256)
